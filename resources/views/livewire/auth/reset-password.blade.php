                ...
                <div>
                    ...
                    <div>
                        ...
                        <x-form wire:submit="updatePassword">
                            <x-input wire:model="token" class="hidden" type="hidden" />
                            <x-input label="E-mail" icon="o-envelope" wire:model="email" />
                            <x-input label="Nova senha" wire:model="password" icon="o-key" type="password" />
                            <x-input label="Confirmar nova senha" wire:model="password_confirmation" icon="o-key" type="password" />
                            <x-slot:actions>
                                <x-button class="btn-primary" label="Trocar Senha" type="submit" spinner="save" />
                            </x-slot:actions>
                        </x-form>
                    </div>
                </div>
